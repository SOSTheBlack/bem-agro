            ...
            <form class="login-form" method="POST" action="{{ route('register') }}">
                ...
                <div class="row margin">
                    <div class="input-field col s12">
                        ...
                        <label for="name" class="center-align">{{ __('Full name') }}</label>
                        @error('name')
                ...
                <div class="row margin">
                    <div class="input-field col s12">
                        ...
                        <input id="password-confirm" type="password" name="password_confirmation"
                               autocomplete="new-password">
                        <label for="password-confirm">{{ __('Password again') }}</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s12">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <p class="margin medium-small"><a href="{{ route('login')}}">{{ __('Already have an account? Login') }}</a>
                        </p>
                    </div>
                </div>
            </form>
